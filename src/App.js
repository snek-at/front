...
import { readCacheAction } from "./store/actions/userActions";
...
//         onClick={() =>
//           dispatch(
//             loginAction({ username: "schettn", password: sha256("test") })
//           )
//         }
//       >
//         {"LOGIN"}
//       </button>
//       <button onClick={() => dispatch(getAllPageUrlsAction())}>
//         {"ALL USERNAMES"}
//       </button>
//       <button onClick={() => dispatch(fetchGitLabServersAction())}>
//         {"ALL GITLAB"}
//       </button>
//       <button onClick={() => dispatch(readCacheAction("pinterid"))}>
//         {"GET SCHETTN CACHE"}
//       </button>
//     </div>
//   );
